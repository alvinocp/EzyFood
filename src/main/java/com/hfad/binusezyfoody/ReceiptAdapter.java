...
public class ReceiptAdapter extends RecyclerView.Adapter<ReceiptAdapter.ViewHolder> {
    ...
    public ReceiptAdapter(Context context, String[] programNameList, String[] programDescriptionList, int[] images){
    ...
    public ReceiptAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.recycler_receipt, parent, false);
